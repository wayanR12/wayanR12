                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <?php foreach ($list as $petugasList):?>
                            ...
                            <tr>
                                ...
                                <td>
                                <?php
                // Cek apakah username yang sedang login sama dengan username pada baris ini
                if ($this->session->userdata('username') == $petugasList->USERNAME) {
            ?>
                <a href="<?php echo base_url() ?>petugas/edit?tken=<?php echo $petugasList->ID_ADMIN ?>" class="btn btn-info btn-xs">
                    <i class="fa fa-edit"> Edit</i>
                </a>
            <?php } ?>
                                    <?php if($this->session->userdata('username') != $petugasList->USERNAME): ?>
