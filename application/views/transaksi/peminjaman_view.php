                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php
                                      $plus = date('Y-m-d',strtotime("+30 day",strtotime(date('Y-m-d'))));
                                    ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tbNama" id="tbNama" class="form-control" placeholder="Pilih Kolom ID Siswa" readonly="readonly">
                                    </div>
                                </div>
                            </div>
                            <div class="row"> 
