    ...
    <div class="container body">
        <div class="main_container">
            <div class="col-md-3 left_col menu_fixed">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="Dashboard" class="site_title"> <span>Perpus ~SMARA~</span></a>
                    </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li>
                                    <a href="<?php echo base_url()?>anggota"><i class="fa fa-users"></i> Siswa</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url()?>buku"><i class="fa fa-book"></i> Buku</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url()?>laporan"><i class="fa fa-book"></i> Laporan</a>
                                </li>
            ...
            <footer>
                ...
                <marquee> Perpustakaan  | SMA Negeri 1 Marabahan</marquee>
                </div>
                <div class="clearfix"></div>
            </footer>
            <!-- /footer content -->
