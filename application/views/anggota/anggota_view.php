<div class="">
    <div class="page-title" style="padding: 8px">
        <div class="title_left">
            <h1><i class="fa fa-users"></i>  Siswa</h1>
        </div>
    </div>
    <?php if($this->session->userdata('role')=='admin'){echo '<a href="'.base_url().'anggota/add" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Tambah Anggota</a>';} ?>
    <div class="clearfix"></div>
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>List Data <small>Siswa</small></h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                <!-- Notif -->
                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>Tanggal Lahir</th>
                                    <th>Jenis Kelamin</th>
                                    <?php if($this->session->userdata('role')=='admin'){echo '<th>Action</th>';} ?>
                                </tr>
                            </thead>
                            <tbody>
                                <?php 
